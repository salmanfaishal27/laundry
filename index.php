...
$query = mysqli_query("SELECT * FROM pengguna WHERE username = '$usr'");
...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="images/img_485762.png">

        <title>Laundry Legends</title>
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><span>Laundry Legends </span></a>
                    </div>
                </div>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Laundry Legends</h4>
