...
echo "<div class='panel panel-border panel-primary'>
									...
									<p align='right'><a class='btn btn-primary' href='?p=jenis&aksi=tambah'><i class='icon-plus'></i>Tambah Jenis Laundry</a></p>
                                   <hr>
						    ...
						    //$hargaa = $r['harga'];
                             echo"<tr>
                                    <td>$r[jenis]</td>
									<td>$r[harga]</td>
                                    <td><a class='btn btn-primary' href='?p=jenis&aksi=edit&id=$r[id]'><i class='icon-edit'></i>Edit</a>
